...
import { Bell, Github, Keyboard, PanelLeft, Palette, Settings } from 'lucide-react'
...
export type SettingsSectionId = 'general' | 'appearance' | 'notifications' | 'layout' | 'github' | 'keyboard'
